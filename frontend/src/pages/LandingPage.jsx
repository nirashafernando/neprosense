...
const LandingPage = () => {
  ...
  const components = [
    ...
    },
    {
      ...
      icon: Heart,
      description:
        "Advanced ML-driven donor-recipient compatibility analysis with risk-based ranking and SHAP explainability for optimal transplant decisions.",
      status: "active",
  ...
  const benefits = [
    {
      ...
      description:
        "Identify CKD risk factors and progression indicators before severe complications develop",
    ...
    },
    {
      ...
      description:
        "Leverage advanced machine learning for accurate risk assessment and decision support",
    ...
    },
    {
      ...
      description:
        "SHAP-based explanations ensure clinicians understand every AI recommendation",
    ...
    },
    {
      ...
      description:
        "Augments medical expertise without replacing professional judgment",
  ...
  return (
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center  animate-fade-in-up">
              <div className="relative">
                <div className="absolute inset-0 bg-white/20 backdrop-blur-sm rounded-full blur-2xl scale-110"></div>
                <img
                  src="/small logo.png"
                  alt="NephroSense"
                  className="relative w-44 h-44 object-contain drop-shadow-2xl ml-16"
                />
              </div>
            </div>
            ...
            <p className="text-lg lg:text-xl text-medical-200 mb-12 max-w-3xl mx-auto animate-fade-in-up animation-delay-600">
              Integrated 4-component intelligent ecosystem for early detection,
              clinical analysis, lifestyle guidance, and transplant matching
            </p>
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="relative bg-gradient-to-br from-medical-50 via-teal-50 to-blue-50 rounded-3xl p-12 mb-20 shadow-xl border-2 border-medical-200/30 overflow-hidden" id="workflow">
          ...
          <div className="relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 max-w-2xl mx-auto">
                Integrated AI support across every stage of chronic kidney
                disease management
              </p>
            </div>
              ...
              {components.map((comp, idx) => {
                ...
                return (
                  <div key={idx} className="relative">
                    <div
                      className={`bg-white/80 backdrop-blur-sm rounded-2xl p-6 border-2 transition-all hover:scale-105 hover:shadow-xl ${
                        isActive
                          ? "border-medical-300 shadow-lg"
                          : "border-slate-200 shadow-md"
                      }`}
                    >
                      <div className="text-center">
                        <div
                          className={`${comp.iconBg} w-14 h-14 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-md`}
                        >
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              Built on cutting-edge AI research with clinician needs at the
              forefront
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, idx) => {
              ...
              return (
                ...
                >
                  <div
                    className={`bg-gradient-to-br ${benefit.gradient} w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform shadow-lg`}
                  >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <a
                href="#"
                className="text-medical-200 hover:text-white transition-colors text-sm font-semibold hover:underline"
              >
                Documentation
              </a>
              <a
