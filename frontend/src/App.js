...
// Import Ultrasound components
import UltrasoundFrontPage from "./components/Ultrasound/FrontPage";
import UltrasoundDashboard from "./components/Ultrasound/Dashboard";
import KidneyUltrasoundSystem from "./components/Ultrasound/KidneyUltrasoundSystem";
import { AnalysisProvider as UltrasoundAnalysisProvider } from "./components/Ultrasound/AnalysisContext";  
      ...
      <Router>
        <div className="App">
          <Routes>
            ...
            {/* Protected Ultrasound Routes */}
            <Route
              path="/ultrasound"
              element={
                <ProtectedRoute>
                  <UltrasoundAnalysisProvider>
                    <UltrasoundFrontPage />
                  </UltrasoundAnalysisProvider>
                </ProtectedRoute>
              }
            >
              <Route index element={<UltrasoundDashboard />} />
