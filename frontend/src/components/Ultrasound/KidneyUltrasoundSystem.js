      ...
      <div className="w-full max-w-md p-8 bg-white shadow-2xl rounded-3xl border border-slate-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <input type="text" className="w-full p-3 bg-slate-100 border border-slate-200 rounded-xl outline-none font-mono text-blue-600 font-bold" value={formData.patientId} readOnly />
          </div>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <select className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-500" value={formData.gender} onChange={(e) => setFormData({ ...formData, gender: e.target.value })}>
