              ...
              <form onSubmit={handleSearch} className="relative">
                <div className="relative">
                  <input
                    ...
                    className="w-full py-2 pl-10 pr-4 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                  />
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center p-1 space-x-2 transition-colors rounded-full hover:bg-gray-100"
                >
                  <img
