...
const FrontPage = () => {
  ...
  const menuItems = [
    {
      ...
      active: location.pathname === "/ultrasound" || location.pathname === "/ultrasound/dashboard",
    },
    {
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const getCurrentPageTitle = () => {
    ...
    if (currentPath === "/ultrasound" || currentPath === "/ultrasound/dashboard") return "Dashboard";
    if (currentPath === "/ultrasound/analysis") return "Kidney Ultrasound Analysis"; 
    return "NephroSense";
  };
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex flex-col w-64 min-h-screen text-white bg-gradient-to-b from-medical-800 via-medical-700 to-medical-900">
        ...
        {/* Support Section */}
        <div className="p-6 border-t border-medical-600">
          ...
          <div className="flex items-center mt-4 space-x-3">
            <img src="https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=60&h=60&fit=crop" alt="Support" className="w-12 h-12 border-2 border-medical-600 rounded-full" />
            <div>
              <p className="text-sm text-medical-200">Nephrosense</p>
              <p className="text-xs text-medical-400">Web</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col flex-1 overflow-hidden"> 
        {/* Header */}
        <div className="z-10 px-6 py-4 bg-white shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-semibold text-gray-800">
                {getCurrentPageTitle()}
              </h1>
              <span className="px-2 py-1 text-sm rounded text-medical-800 bg-medical-100">
                Active
              </span>
            </div>
            ...
            <div className="flex-1 max-w-md mx-8">
              <form onSubmit={handleSearch} className="relative">
                <input
                  ...
                  className="w-full py-2 pl-10 pr-4 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-medical-700"
                />
            ...
            <div className="relative">
              ...
              {showProfile && (
                <div className="absolute right-0 z-50 w-48 py-2 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg">
                  ...
                  <button className="block w-full px-4 py-2 text-sm text-left text-gray-700 hover:bg-gray-100">Profile Settings</button>
                  <button className="block w-full px-4 py-2 text-sm text-left text-gray-700 hover:bg-gray-100">Sign Out</button>
                </div>
              )}
            </div>
          </div>
